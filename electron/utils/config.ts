 ...
 */
export const PORTS = {
  /** MimiClaw GUI development server port */
  MIMICLAW_DEV: 5173,
  
  /** MimiClaw GUI production port (for reference) */
  MIMICLAW_GUI: 23333,

  /** Local host API server port */
  MIMICLAW_HOST_API: 3210,
...
export function getPort(key: keyof typeof PORTS): number {
  const envKey = `MIMICLAW_PORT_${key}`;
...
export const APP_PATHS = {
  ...
  /** MimiClaw configuration directory */
  MIMICLAW_CONFIG: '~/.mimiclaw',
