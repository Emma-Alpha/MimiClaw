 ...
 * "openrouter.ai" carries the MimiClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__mimiclawFetchPatched) return;
  globalThis.__mimiclawFetchPatched = true;

  globalThis.fetch = function mimiclawFetch(input, init) {
    var url =
