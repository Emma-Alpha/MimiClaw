...
[Releases](https://github.com/Emma-Alpha/JizhiClaw/releases)ページから、お使いのプラットフォーム向けの最新リリースをダウンロードしてください。
...
<p align="center">
  <img src="https://api.star-history.com/svg?repos=Emma-Alpha/JizhiClaw&type=Date" alt="スター履歴チャート" />
</p>
