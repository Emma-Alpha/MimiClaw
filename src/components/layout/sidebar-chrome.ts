...
const CODEX_DARK_SURFACE = '#111111';
const CODEX_DARK_CANVAS = '#111111';
...
const CODEX_LIGHT_CANVAS = '#ffffff';
...
export function getSidebarChromeCss() {
  return `
    ...
    --mimi-sidebar-canvas-background: ${CODEX_LIGHT_CANVAS};
    ...
    [data-theme='dark'] & {
      ...
      --mimi-sidebar-canvas-background: ${CODEX_DARK_CANVAS};
