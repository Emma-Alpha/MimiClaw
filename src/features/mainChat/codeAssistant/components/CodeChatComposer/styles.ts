...
export const useComposerStyles = createStyles(({ css, token }) => ({
	...
	pill: css`
		...
		align-items: center;
		padding: ${CODEX_COMPOSER_TOP_PADDING}px ${CODEX_COMPOSER_HORIZONTAL_PADDING}px ${CODEX_COMPOSER_BOTTOM_PADDING}px;
		border-radius: ${CODEX_COMPOSER_RADIUS}px;
		--code-chat-ring-color: var(--color-token-border, ${token.colorBorder});
		--code-chat-ring-color-focus: var(--color-token-border-heavy, var(--color-token-border, ${token.colorBorder}));
		...
		box-shadow:
			${CODEX_COMPOSER_HIGHLIGHT},
			0 0 0 0.5px var(--code-chat-ring-color);
		position: relative;
		min-height: ${CODEX_COMPOSER_MIN_HEIGHT}px;
		box-sizing: border-box;
		width: 100%;

		@supports (corner-shape: superellipse(1.5)) {
			border-radius: ${CODEX_COMPOSER_SUPERELLIPSE_RADIUS}px;
		...
		&:focus-within {
			...
			box-shadow:
				${CODEX_COMPOSER_HIGHLIGHT},
				0 0 0 0.5px var(--code-chat-ring-color-focus);
		}
	`,
	pillFused: css`
