...
export type CodeChatHeaderViewModel = {
	isCodeMode: boolean;
	headerTitle: string;
	islandLabel: string;
...
export type BuildCodeChatHeaderViewModelInput = {
...
export function buildCodeChatHeaderViewModel(
	input: BuildCodeChatHeaderViewModelInput,
): CodeChatHeaderViewModel {
