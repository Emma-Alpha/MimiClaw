...
if /i "%1"=="update" (
    echo openclaw is managed by MimiClaw ^(bundled version^).
    echo.
    echo To update openclaw, update MimiClaw:
    echo   Open MimiClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=MimiClaw
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\MimiClaw.exe" "%OPENCLAW_ENTRY%" %*
)
